    ...
    <div className="publish-step publish-step--details">
      ...
      >
        <EntityTaggingPanel
          ...
          hint={
            mediaType === "text"
              ? "حدّد اسماً في العنوان أو الوصف ثم اضغط «اربط النص». نص المقال يُربَط أيضاً في خطوة المحتوى."
              : "المقال ليس نصاً — حدّد اسماً في العنوان أو الوصف ثم اضغط «اربط النص» ليظهر للقارئ."
          }
          dockHint="حدّد اسماً في العنوان أو الوصف ثم اضغط الزر"
        >
