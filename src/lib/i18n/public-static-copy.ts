...
export const PUBLIC_STATIC_COPY: Record<Locale, PublicStaticCopy> = {
  ar: {
    ...
    partnersList: [
      ...
      {
        id: "ccfd",
        title: "سي سي إف دي — تير سوليدير",
        logoAlt: "CCFD-Terre Solidaire",
        initials: "CCFD",
      },
      {
        id: "rsf",
        title: "مراسلون بلا حدود",
        logoAlt: "مراسلون بلا حدود — RSF",
        initials: "RSF",
      },
      {
        id: "euro-med",
        title: "الأورومتوسطي لحقوق الإنسان",
        logoAlt: "Euro-Med Human Rights Monitor",
        initials: "EMHRM",
      },
      {
        id: "wacc",
      ...
      {
        id: "boell",
        title: "مؤسسة هاينريش بول — فلسطين والأردن",
        logoAlt: "Heinrich Böll Stiftung Palestine and Jordan",
        initials: "HBS",
      },
      {
        id: "care",
  ...
  en: {
    ...
    partnersList: [
      ...
      },
      {
        ...
        logoAlt: "Reporters Without Borders — RSF",
        initials: "RSF",
      },
      {
        id: "euro-med",
      ...
      {
        id: "boell",
        title: "Heinrich Böll Stiftung Palestine and Jordan",
        logoAlt: "Heinrich Böll Stiftung Palestine and Jordan",
        initials: "HBS",
      },
      {
